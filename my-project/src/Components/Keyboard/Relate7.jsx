...
const Relate7 = () => {
  ...
  return (
    <div className="w-full bg-white/95 py-8 xl:p-20 p-5">
  <div>
      ...
      {filteredProducts.length > 0 ? (
        filteredProducts.map((product) => (
          <Link to={`/viewcase/${product._id}`} key={product._id}>
            <div className="group border border-transparent bg-white overflow-hidden p-10 h-full md:h-[54vh] lg:h-[43vh] xl:h-[70vh] ">
              <img
