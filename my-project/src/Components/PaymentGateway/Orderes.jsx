...
const ViewOrders = () => {
  ...
  return (
    <div className="h-full bg-black p-6">
      ...
      {orders.length === 0 ? (
        <p className="text-center text-gray-400">No orders found for this user.</p>
      ) : (
        <div className="space-y-6">
          {orders.map((order) => (
            <div
              key={order._id}
              className="border border-gray-400 p-4 rounded-lg shadow-md grid md:grid-cols-2 text-gray-400 gap-7 p-7"
            >
              <div className="mt-4">
                <h4 className="text-lg font-bold mb-2 font-mono text-red-500">
                  Product Details:
                </h4>
                ...
                {order.status === 'paid' && (
                  <div className="mt-4 flex items-center justify-end">
                    <button
                      ...
                      className="bg-red-700 text-white p-2 rounded-lg shadow-lg hover:bg-red-600 flex items-center space-x-2"
                    >
